...
class AndroidEmulatorBase(Protocol):
    ...
    def call(self, target: int | Symbol | NativePointer, *args: object, return_pointer: bool = False) -> int | NativePointer: ...
    ...
    def _marshal_native(self, this_ref: int, arg_types: list[str], args: list[object]) -> None: ...
