...
@dataclass
class FileStat:
    _FIXED_MTIME = 1677974400
    _BLKSIZE = 0x1000
    REG_MODE = StatType.S_IFREG | 0x1A4  # 0644
    DIR_MODE = StatType.S_IFDIR | 0x16D  # 0755
    CHR_MODE = StatType.S_IFCHR | 0x1B6  # 0666
    SOCK_MODE = StatType.S_IFSOCK | 0x1FF  # 0777
    FIFO_MODE = StatType.S_IFIFO | 0x1A4  # 0644
    ANON_MODE = StatType.S_IFREG | 0x180  # 0600
