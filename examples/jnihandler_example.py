...
LIB = os.path.join(os.path.dirname(__file__), "..", "tests", "fixtures", "libnative.so")
ROOTFS = "path/to/android/rootfs"
...
emu = AndroidEmulator64(ROOTFS, log=LogCategory.NONE, jni_handler=DemoJniHandler())
emu.load(LIB)
...
emu.call_static_native(
    "com/github/unidbg/android/JniTest", "testJni", "(Ljava/lang/String;JIDZSFDBJF)V",
    "hello from python", 0x123456789ABCDEF, 0x789A, 0.12345, True, 0x123, 0.456, 0.789, 0x7F, 0x89ABCDEF, 0.123)
print("done")
